...
4. Click the "+" button next to "Unreal versions", then click the little drop down to select the version you want to install:![](./images/chooseunrealversion.png)
5. Once you've selected the version, click the "Install" button.
6. Select a target folder and click Install. I like to keep everything together, but you can install it anywhere:![](./images/installunreal5.png)
